...
uses
  Forms, Classes, Controls, Grids, rechercheclasses, DBGrids, DB, DBClient,
...
type
  ...
  private
    FContainer: TRechercheFrame;
  public
    constructor Create(AContainer: TWinControl);
    destructor Destroy; override;
    property Container: TRechercheFrame read FContainer write FContainer;
  end;
...
begin
  FContainer := AContainer as TRechercheFrame;
end;
...
constructor TRechercheFrame.Create(AOwner: TComponent);
begin
  inherited;
  FDBViewList := TDBViewList.Create();
end;

destructor TRechercheFrame.Destroy;
begin
  FreeAndNil(FDBViewList);
  inherited Destroy;
end;

procedure TRechercheFrame.DisplayDBViews;
var
  i: Integer;
begin
