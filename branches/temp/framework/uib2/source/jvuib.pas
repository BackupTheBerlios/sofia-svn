...
(*                                                                              *)
(********************************************************************************)
(* $Id: jvuib.pas,v 1.43 2005/03/21 22:07:32 progdigy Exp $                     *)
(********************************************************************************)
...
constructor TJvUIBSecurity.Create(aOwner: TComponent);
begin
  inherited;
...
constructor TJvUIBEvents.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
...
begin
  ...
  for i := FThreads.Count - 1 downto 0 do
    with TJvUIBEventThread(FThreads[0]) do
    begin
      FThreads.Delete(i);
