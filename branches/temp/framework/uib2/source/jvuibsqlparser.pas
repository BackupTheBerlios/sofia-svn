...
(*                                                                              *)
(********************************************************************************)
(* $Id: jvuibsqlparser.pas,v 1.9 2005/01/31 23:29:36 progdigy Exp $             *)
(********************************************************************************)
...
type
  ...
  TSQLToken = (toValString, toSymbol, toValNumber, toValFloat, toNotLSS, toNEQ,
    ...
    toWHERE, toWHILE, toWITH, toWORK, toWRITE, toYEAR, toYEARDAY, toEOF);

  TSQLStatement = (ssUnknow, ssAlterException, ssAlterTable, ssAlterTrigger,
    ssAlterProcedure, ssAlterDatabase, ssAlterDomain, ssAlterIndex, ssReadBlob,
    ssInsertBlob, ssCommit, ssDeclareFilter, ssDeclareFunction, ssDelete,
    ssDropException, ssDropIndex, ssDropProcedure, ssDropTable, ssDropTrigger,
    ssDropView, ssDropFilter, ssDropDomain, ssDropFunction, ssDropShadow,
    ssDropRole, ssDropGenerator, ssGrant, ssInsertInto, ssExecuteProcedure,
    ssRecreateProcedure, ssRecreateTable, ssRecreateView, ssSetSqlDialect,
    ssSetTransaction, ssSetGenerator, ssSetStatistics, ssSetNames,
    ssCreateException, ssCreateIndex, ssCreateProcedure, ssCreateTable,
    ssCreateTrigger, ssCreateView, ssCreateGenerator, ssCreateDatabase,
    ssCreateDomain, ssCreateShadow, ssCreateRole, ssReplaceProcedure,
    ssReplaceTrigger, ssRevoke, ssRollback, ssSetSavepoint, ssReleaseSavepoint,
    ssUndoSavepoint, ssSelect, ssUpdate, ssDebug, ssAutoDDL, ssConnect, ssEOF);
...
begin
  ...
  case Next of
    ...
    toEXECUTE: result := ssExecuteProcedure;
    toRECREATE:
      case Next of
      ...
      begin
        ...
        case CM[FCursor[0]] of
          ...
          'B': case get of
                 ...
                 'I': if (get = 'G') and (get = 'I') and (get = 'N') and (get = 'T') and (get = ' ') then
                        result := toBIGINT;
                 'L': if (get = 'O') and (get = 'B') and (get = ' ') then
                        result := toBLOB;
          ...
          'C': case get of
                 ...
                 'O': case get of
                        'A': if (get = 'L') and (get = 'E') and (get = 'S') and
                               ...
                               result := toCOALESCE;
                        'L': case get of
                               'L': if (get = 'A') and (get = 'T') and (get = 'E') and (get = ' ') then
                                      result := toCOLLATE;
                               'U': if (get = 'M') and (get = 'N') and (get = ' ') then
                                      result := toCOLUMN;
                             end;
                        'M': case get of
                               'M': if (get = 'I') and (get = 'T') then
                                      case get of
                                        ' ': result := toCOMMIT;
          ...
          'L': case get of
                 'A': if (get = 'S') and (get = 'T') and (get = ' ') then
                        result := toLAST;
                 'E': case get of
                        'A': if (get = 'V') and (get = 'E') and (get = ' ') then result := toLEAVE;
          ...
          'O': case get of
                 ...
                 'P': if (get = 'T') and (get = 'I') and (get = 'O') and (get = 'N') and (get = ' ') then
                        result := toOPTION;
                 'R': case get of
                        ' ': result := toOR;
          ...
          'R': case get of
                 ...
                 'E': case get of
                        ...
                        'S': case get of
                               ...
                               'T': if (get = 'R') and (get = 'I') and (get = 'C') and (get = 'T') and (get = ' ') then
                                      result := toRESTRICT;
                             end;
                        'T': case get of
                               ...
                               'U': if (get = 'R') and (get = 'N') then
                                      case get of
                                        'I': if (get = 'N') and (get = 'G') and (get = '_') and (get = 'V') and
                                                (get = 'A') and (get = 'L') and (get = 'U') and (get = 'E') and
                                                (get = 'S') and (get = ' ') then
                                               result := toRETURNING_VALUES;
                 ...
                 'O': case get of
                        ...
                        'W': if (get = '_') and (get = 'C') and (get = 'O') and (get = 'U') and
                                (get = 'N') and (get = 'T') and (get = ' ') then
                               result := toROW_COUNT;
                      end;
               end;
          'S': case get of
                 'A': if (get = 'V') and (get = 'E') and (get = 'P') and (get = 'O') and
                         (get = 'I') and (get = 'N') and (get = 'T') and (get = ' ') then
                        result := toSAVEPOINT;
                 'C': if (get = 'H') and (get = 'E') and (get = 'M') and (get = 'A') and (get = ' ') then
                        result := toDATABASE;
                 'E': case get of
          ...
          'T': case get of
                 ...
                 'O': if (get = ' ') then
                        result := toTO;
                 'R': case get of
                        'A': if (get = 'N') and (get = 'S') and (get = 'A') and (get = 'C') and
                                (get = 'T') and (get = 'I') and (get = 'O') and (get = 'N') and
                                (get = ' ') then
                               result := toTRANSACTION;
                        'I': if (get = 'G') and (get = 'G') and (get = 'E') and
                                (get = 'R') and (get = ' ') then
                               result := toTRIGGER;
                      end;
