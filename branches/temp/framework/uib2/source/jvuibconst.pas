...
(*                                                                              *)
(********************************************************************************)
(* $Id: jvuibconst.pas,v 1.9 2004/12/15 18:04:15 progdigy Exp $                 *)
(********************************************************************************)
...
const
  ...
  // ORB Errors
  EJvUIB_CantConnect   = 'Sunucu baрlantэsэ kurulamadэ.';
  EJvUIB_ClassNotFound = 'Sэnэf bulunamadэ.';
  EJvUIB_DataType      = 'Veri tipi hatasэ.';
  {$ENDIF UIBLANG_TR}
