...
INTERFACE
  ...
  procedure CreateHueSaturationCircle(Bitmap : TBitmap; CONST size:  INTEGER; CONST HueLevel:  INTEGER; CONST SaturationLevel:  INTEGER; CONST ValueLevel:  INTEGER; CONST BackgroundColor:  TColor; CONST SaturationCircleColor:  TColor; CONST HueLineColor:  TColor);
...
{    // Fill with background color
    ...
    Bitmap.Canvas.FillRect(RESULT.Canvas.ClipRect);  }
    ...
    THEN BEGIN
      Bitmap.Canvas.Pen.Color := SaturationCircleColor;
      Bitmap.Canvas.Brush.Style := bsClear;
      delta := MulDiv(Radius, SaturationLevel, 255);
      Bitmap.Canvas.Ellipse(Radius - delta,
                            Radius - delta,
                            Radius + delta,
                            Radius + delta);
    END;
    ...
    THEN BEGIN
      ...
      Bitmap.Canvas.Pen.Color := HueLineColor;
      Bitmap.Canvas.MoveTo(Radius,Radius);
      Bitmap.Canvas.LineTo(Radius + Round(Radius*COS(angle)),
