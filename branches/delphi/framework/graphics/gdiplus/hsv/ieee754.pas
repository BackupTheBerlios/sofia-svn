...
{$ELSE}           // Delphi 1-3
  ...
  CONST
    NANQuietBits         :  ARRAY[1..2] OF CARDINAL = ($FFFFFFFF, $7FFFFFFF);
    PositiveInfinityBits :  ARRAY[1..2] OF CARDINAL = ($00000000, $7FF00000);
    NegativeInfinityBits :  ARRAY[1..2] OF CARDINAL = ($00000000, $FFF00000);
