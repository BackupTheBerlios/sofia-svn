...
namespace Sofia.Data.Common
{
    internal interface ICommandFactory
    {
        ...
        /// <summary>/ Ajoute un paramètre pour la commande
        /// </summary>
        ...
        /// <summary> Instancie un objet DbCommand
        /// </summary>
        /// <returns>un objet DbCommand</returns>
        DbCommand CreateCommand(CommandType commandType);

        /// <summary> Vide la liste des paramètres
        /// </summary>
        void FlushParameters();

        /// <summary> Requête SQL ou nom d'une procédure stockée
        /// </summary>
